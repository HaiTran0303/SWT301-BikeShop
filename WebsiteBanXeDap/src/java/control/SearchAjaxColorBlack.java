 ...
 * @author MSI GF
 */
@WebServlet(name="SearchAjaxColorBlack", urlPatterns={"/searchAjaxColorBlack"})
public class SearchAjaxColorBlack extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        DAO d = new DAO();
        List<Product> list = d.searchColorBlack();
