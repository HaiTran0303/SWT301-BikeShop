 ...
 * @author MSI GF
 */
@WebServlet(name="SearchAjaxColorGray", urlPatterns={"/searchAjaxColorGray"})
public class SearchAjaxColorGray extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        DAO d = new DAO();
        List<Product> list = d.searchColorGray();
