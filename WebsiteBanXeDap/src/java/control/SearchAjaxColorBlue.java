 ...
 * @author MSI GF
 */
@WebServlet(name="SearchAjaxColorBlue", urlPatterns={"/searchAjaxColorBlue"})
public class SearchAjaxColorBlue extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        DAO d = new DAO();
        List<Product> list = d.searchColorBlue();
