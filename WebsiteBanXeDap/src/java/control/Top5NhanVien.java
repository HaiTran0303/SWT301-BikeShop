 ...
 * @author MSI GF
 */
@WebServlet(name="Top5NhanVien", urlPatterns={"/top5nhanvien"})
public class Top5NhanVien extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<TongChiTieuBanHang> listTop5NhanVien = d.getTop5NhanVien();
