 ...
 * @author MSI GF
 */
@WebServlet(name="SearchAjaxColorGreen", urlPatterns={"/searchAjaxColorGreen"})
public class SearchAjaxColorGreen extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        DAO d = new DAO();
        List<Product> list = d.searchColorGreen();
