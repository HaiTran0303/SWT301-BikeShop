...
public class AddProductServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        DAO d = new DAO();
        d.insertProduct(pname, pimage, pprice, ptitle, pdescription, pcategory, sid, pmodel, pcolor, pdelivery, pimage2, pimage3, pimage4);
        request.setAttribute("mess", "Product Add!");
