 ...
 * @author MSI GF
 */
@WebServlet(name="SearchAjaxColorRed", urlPatterns={"/searchAjaxColorRed"})
public class SearchAjaxColorRed extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        DAO d = new DAO();
        List<Product> list = d.searchColorRed();
