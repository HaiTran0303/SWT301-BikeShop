 ...
 * @author MSI GF
 */
@WebServlet(name="SearchAjaxColorWhite", urlPatterns={"/searchAjaxColorWhite"})
public class SearchAjaxColorWhite extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        DAO d = new DAO();
        List<Product> list = d.searchColorWhite();
