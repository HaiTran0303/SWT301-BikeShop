 ...
 * @author MSI GF
 */
@WebServlet(name="TotalMoneyCart", urlPatterns={"/totalMoneyCart"})
public class TotalMoneyCart extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        PrintWriter out = response.getWriter();
        		out.println(" <div class=\"d-flex justify-content-between mb-3 pt-1\">\n" +
"                                <h6 class=\"font-weight-medium\">Subtotal</h6>\n" +
"                                <h6 class=\"font-weight-medium\"><strong>"+totalMoney+"</strong></h6>\n" +
"                            </div>\n" +
